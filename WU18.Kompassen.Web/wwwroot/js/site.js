...
function getStudentsAndCourses(courses) {
    ...
    for (i = 0; i < looplength; i++) {
        ...
        studentcourse.forEach(function (linkedStudents) {
            $panelGenerator.append('<li class="list-group-item">' + linkedStudents.firstName + ' ' + linkedStudents.lastName + '   <span class="glyphicon glyphicon-trash pull-right" aria-hidden="true"></span>           <span class="glyphicon glyphicon-pencil pull-right" aria-hidden="true"></span> </li>');
        });
